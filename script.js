...
!(function (e, t) {
  ...
  function S(e, t, n, i) {
    ...
    if (p && ((o = f(t, e[0].ownerDocument, !1, e, i)), (r = o.firstChild), 1 === o.childNodes.length && (o = r), r || i)) {
      ...
      if (s) for (c = a[a.length - 1].ownerDocument, oe.map(a, x), d = 0; d < s; d++) (l = a[d]), je.test(l.type || "") && !Ce.access(l, "globalEval") && oe.contains(c, l) && (l.src ? oe._evalUrl && oe._evalUrl(l.src) : oe.globalEval(l.textContent.replace($e, "")));
    }
    return e;
  }
  ...
  function N(e, t, n) {
    ...
    n.queue ||
      ...
      1 === e.nodeType && ("height" in t || "width" in t) && ((n.overflow = [f.overflow, f.overflowX, f.overflowY]), (c = oe.css(e, "display")), "inline" === ("none" === c ? Ce.get(e, "olddisplay") || _(e.nodeName) : c) && "none" === oe.css(e, "float") && (f.display = "inline-block")),
      n.overflow &&
        ((f.overflow = "hidden"),
        u.always(function () {
    ...
    (oe.extend = oe.fn.extend =
      function () {
        var e,
          ...
          l = arguments.length,
          c = !1;
        for ("boolean" == typeof a && ((c = a), (a = arguments[s] || {}), s++), "object" == typeof a || oe.isFunction(a) || (a = {}), s === l && ((a = this), s--); s < l; s++) if (null != (e = arguments[s])) for (t in e) (n = a[t]), (i = e[t]), a !== i && (c && i && (oe.isPlainObject(i) || (o = oe.isArray(i))) ? (o ? ((o = !1), (r = n && oe.isArray(n) ? n : [])) : (r = n && oe.isPlainObject(n) ? n : {}), (a[t] = oe.extend(c, r, i))) : void 0 !== i && (a[t] = i));
        return a;
      }),
    oe.extend({
              ...
              return 1 === i && 0 === o
                ...
                : function (t, n, l) {
                    ...
                    if (g) {
                      ...
                      } else if ((y && ((f = t), (d = f[N] || (f[N] = {})), (u = d[f.uniqueID] || (d[f.uniqueID] = {})), (c = u[e] || []), (p = c[0] === P && c[1]), (x = p)), !1 === x)) for (; (f = (++p && f && f[m]) || (x = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++x || (y && ((d = f[N] || (f[N] = {})), (u = d[f.uniqueID] || (d[f.uniqueID] = {})), (u[e] = [P, x])), f !== t)); );
      ...
      (C = t.tokenize =
        function (e, n) {
          ...
          for (s = e, l = [], c = w.preFilter; s; ) {
            (i && !(o = ae.exec(s))) || (o && (s = s.slice(o[0].length) || s), l.push((r = []))),
              (i = !1),
              (o = se.exec(s)) &&
                ((i = o.shift()),
                r.push({
  ...
  ((oe.fn.init = function (e, t, n) {
    ...
    if (((n = n || me), "string" == typeof e)) {
      ...
      if (i[1]) {
        if (((t = t instanceof oe ? t[0] : t), oe.merge(this, oe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : G, !0)), pe.test(i[1]) && oe.isPlainObject(t))) for (i in t) oe.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
        return this;
      }
  ...
  oe.extend(oe.event, {
    trigger: function (t, n, i, o) {
      ...
      if (((a = s = i = i || G), 3 !== i.nodeType && 8 !== i.nodeType && !pt.test(p + oe.event.triggered) && (p.indexOf(".") > -1 && ((h = p.split(".")), (p = h.shift()), h.sort()), (c = p.indexOf(":") < 0 && "on" + p), (t = t[oe.expando] ? t : new oe.Event(p, "object" == typeof t && t)), (t.isTrigger = o ? 2 : 3), (t.namespace = h.join(".")), (t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null), (t.result = void 0), t.target || (t.target = i), (n = null == n ? [t] : oe.makeArray(n, [t])), (d = oe.event.special[p] || {}), o || !d.trigger || !1 !== d.trigger.apply(i, n)))) {
        ...
        for (r = 0; (a = f[r++]) && !t.isPropagationStopped(); ) (t.type = r > 1 ? l : d.bindType || p), (u = (Ce.get(a, "events") || {})[t.type] && Ce.get(a, "handle")), u && u.apply(a, n), (u = c && a[c]) && u.apply && Se(a) && ((t.result = u.apply(a, n)), !1 === t.result && t.preventDefault());
      ...
      ajax: function (t, n) {
        function i(t, n, i, s) {
          ...
          2 !== w &&
            ...
            i && (x = z(f, S, i)),
            (x = X(f, x, S, c)),
            c ? (f.ifModified && ((b = S.getResponseHeader("Last-Modified")), b && (oe.lastModified[r] = b), (b = S.getResponseHeader("etag")) && (oe.etag[r] = b)), 204 === t || "HEAD" === f.type ? (C = "nocontent") : 304 === t ? (C = "notmodified") : ((C = x.state), (d = x.data), (y = x.error), (c = !y))) : ((y = C), (!t && C) || ((C = "error"), t < 0 && (t = 0))),
            (S.status = t),
            (S.statusText = (n || C) + ""),
    ...
    oe.fn.extend({
      ...
      position: function () {
        if (this[0]) {
          ...
          return (
            "fixed" === oe.css(n, "position") ? (t = n.getBoundingClientRect()) : ((e = this.offsetParent()), (t = this.offset()), oe.nodeName(e[0], "html") || (i = e.offset()), (i.top += oe.css(e[0], "borderTopWidth", !0)), (i.left += oe.css(e[0], "borderLeftWidth", !0))),
            {
          ...
          var t,
            ...
            v = function () {
              var t = e(this),
                ...
                s = [
                  "<div id='mCSB_" + o.idx + "_scrollbar_vertical' class='mCSB_scrollTools mCSB_" + o.idx + "_scrollbar mCS-" + r.theme + " mCSB_scrollTools_vertical" + a + "'><div class='" + u[12] + "'><div id='mCSB_" + o.idx + "_dragger_vertical' class='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div class='mCSB_dragger_bar' /></div><div class='mCSB_draggerRail' /></div></div>",
                  "<div id='mCSB_" + o.idx + "_scrollbar_horizontal' class='mCSB_scrollTools mCSB_" + o.idx + "_scrollbar mCS-" + r.theme + " mCSB_scrollTools_horizontal" + a + "'><div class='" + u[12] + "'><div id='mCSB_" + o.idx + "_dragger_horizontal' class='mCSB_dragger' style='position:absolute;' oncontextmenu='return false;'><div class='mCSB_dragger_bar' /></div><div class='mCSB_draggerRail' /></div></div>",
                ],
              ...
              if (o.advanced.autoExpandHorizontalScroll && "y" !== o.axis) {
                ...
                3 === o.advanced.autoExpandHorizontalScroll || (2 !== o.advanced.autoExpandHorizontalScroll && a > r.parent().width())
                  ...
                  : r
                      ...
                      .css({
                        width: Math.ceil(r[0].getBoundingClientRect().right + 0.4) - Math.floor(r[0].getBoundingClientRect().left),
                        "min-width": "100%",
                        position: "relative",
                      })
                      .unwrap();
                ...
                e.extend(e.expr[":"], {
                  ...
                  mcsInSight:
                    ...
                    function (t) {
                      ...
                      if (s.length) return (n = [a.outerHeight(!1), a.outerWidth(!1)]), (o = [s[0].offsetTop + ne(a)[0], s[0].offsetLeft + ne(a)[1]]), (i = [s.parent()[0].offsetHeight, s.parent()[0].offsetWidth]), (r = [n[0] < i[0] ? [0.9, 0.1] : [0.6, 0.4], n[1] < i[1] ? [0.9, 0.1] : [0.6, 0.4]]), o[0] - i[0] * r[0][0] < 0 && o[0] + n[0] - i[0] * r[0][1] >= 0 && o[1] - i[1] * r[1][0] < 0 && o[1] + n[1] - i[1] * r[1][1] >= 0;
                    },
                  mcsOverflow:
                    e.expr[":"].mcsOverflow ||
                    function (t) {
...
var getImageData = function (e) {
  ...
  render = function (e) {
    requestAnimationFrame(render), (particles.geometry.verticesNeedUpdate = !0), isMouseDown || ((camera.position.x += 0.06 * (0 - camera.position.x)), (camera.position.y += 0.06 * (0 - camera.position.y)), camera.lookAt(centerVector)), renderer.render(scene, camera);
  },
  Yahia = {
    load: function (e) {
      var t;
